        ...
        <body>
            ...
            <header>
                <nav class="navbar navbar-expand-md navbar-dark" style="background-color: tomato">
                    <div>
                        <a href="homePage.html" class="navbar-brand"> Item Management App </a>
                    </div>
            ...
            <div class="container col-md-5">
                <div class="card">
                    <div class="card-body">
                        <c:if test="${item != null}">
                            <form action="<%= request.getContextPath() %>/ItemServlet/item/update" method="post">
                        </c:if>
                        <c:if test="${item == null}">
                            <form action="<%= request.getContextPath() %>/ItemServlet/item/insert" method="post">
                        </c:if>
